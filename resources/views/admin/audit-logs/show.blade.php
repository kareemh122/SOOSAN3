@php
    // Helper for field icons (must be at the top to avoid undefined function error)
    if (!function_exists('getAuditFieldIcon')) {
        function getAuditFieldIcon($field)
        {
            $map = [
                'user' => 'fa-user',
                'name' => 'fa-id-card',
            ...
            <div class="col-lg-6 mb-4">
                <div class="modern-audit-show-card fade-in-up">
                    <div class="card-header"
                        style="background: rgba(248, 250, 252, 0.8); border-bottom: 1px solid rgba(226, 232, 240, 0.5); padding: 1.5rem;">
                    ...
                    <div class="card-body" style="padding: 1.5rem;">
                        <table class="modern-info-table">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="modern-badge bg-{{ $color }}">
                                        <i
                                            class="fas fa-{{ $auditLog->event == 'created' ? 'plus' : ($auditLog->event == 'updated' ? 'edit' : 'trash') }}"></i>
                                ...
                                <td>
                                    @if ($auditLog->user)
                                        <div class="d-flex align-items-center">
                                            <div class="modern-avatar bg-primary me-2"
                                                style="width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 14px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <code
                                        class="bg-light px-2 py-1 rounded">{{ $auditLog->ip_address ?? __('audit-logs.table.na') }}</code>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="badge bg-secondary">{{ $auditLog->method ?? __('audit-logs.table.na') }}</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <code class="bg-light px-2 py-1 rounded"
                                        style="word-break: break-all;">{{ $auditLog->url ?? __('audit-logs.table.na') }}</code>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <small class="text-muted"
                                        style="word-break: break-all;">{{ Str::limit($auditLog->user_agent, 100) ?? __('audit-logs.table.na') }}</small>
                                </td>
                            </tr>
                        </table>
                    </div>
                                    ...
                                    @foreach ($auditLog->old_values as $field => $value)
                                        <div class="col-md-6 mb-3">
                                            <div class="modern-card p-3 h-100"
                                                style="background:rgba(255,255,255,0.95);border-radius:14px;box-shadow:0 2px 8px rgba(102,126,234,0.08);border:1px solid #e2e8f0;">
                                                <div class="d-flex align-items-center mb-2">
                                                    <span class="badge bg-danger me-2" style="font-size:0.85em;"><i
                                                            class="fas fa-minus"></i></span>
                                                    <span class="me-2">{!! getAuditFieldIcon($field) !!}</span>
                                                    <span class="fw-bold text-secondary">{{ $field }}</span>
                                                </div>
                            ...
                            @if ($auditLog->new_values)
                                ...
                                <div class="row">
                                    @foreach ($auditLog->new_values as $field => $value)
                                        <div class="col-md-6 mb-3">
                                            <div class="modern-card p-3 h-100"
                                                style="background:rgba(255,255,255,0.95);border-radius:14px;box-shadow:0 2px 8px rgba(16,185,129,0.08);border:1px solid #e2e8f0;">
                                                <div class="d-flex align-items-center mb-2">
                                                    <span class="badge bg-success me-2" style="font-size:0.85em;"><i
                            ...
                            @if ($auditLog->old_values && $auditLog->event === 'deleted')
                                ...
                                <div class="row">
                                    @foreach ($auditLog->old_values as $field => $value)
                                        <div class="col-md-6 mb-3">
                                            <div class="modern-card p-3 h-100"
                                                style="background:rgba(255,255,255,0.95);border-radius:14px;box-shadow:0 2px 8px rgba(239,68,68,0.08);border:1px solid #e2e8f0;">
                                                <div class="d-flex align-items-center mb-2">
                                                    <span class="badge bg-danger me-2" style="font-size:0.85em;"><i
