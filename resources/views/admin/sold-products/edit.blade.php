            ...
            <div class="modern-card">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="text-center">
                        ...
                        <p class="text-muted">{{ $soldProduct->product->model_name ?? __('sold-products.na') }} -
                            {{ $soldProduct->owner->name ?? __('sold-products.na') }}</p>
                    </div>
                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="modern-form-group">
                                    <label for="product_id" class="modern-label">Product <span
                                    ...
                                    <select class="modern-select @error('product_id') is-invalid @enderror" id="product_id"
                                        ...
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}"
                                                {{ old('product_id', $soldProduct->product_id) == $product->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="modern-form-group">
                                    <label for="owner_id" class="modern-label">{{ __('sold-products.owner') }} <span
                                            class="text-danger">*</span></label>
                                    <select class="modern-select @error('owner_id') is-invalid @enderror" id="owner_id"
                                        ...
                                        @foreach ($owners as $owner)
                                            <option value="{{ $owner->id }}"
                                                {{ old('owner_id', $soldProduct->owner_id) == $owner->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="modern-form-group">
                                    <label for="user_id" class="modern-label">{{ __('sold-products.employee') }} <span
                                            class="text-danger">*</span></label>
                                    ...
                                    @if ($currentUser->isEmployee())
                                        <select class="modern-select" id="user_id" name="user_id" disabled>
                                            <option value="{{ $currentUser->id }}" selected>{{ $currentUser->name }}
                                                ({{ ucfirst($currentUser->role) }})</option>
                                        </select>
                                        <input type="hidden" name="user_id" value="{{ $currentUser->id }}">
                                    @else
                                        <select class="modern-select @error('user_id') is-invalid @enderror" id="user_id"
                                            name="user_id" required>
                                            <option value="">{{ __('sold-products.select_employee') }}</option>
                                            @foreach ($employees as $employee)
                                                <option value="{{ $employee->id }}"
                                                    {{ old('user_id', $soldProduct->user_id) == $employee->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="modern-form-group">
                                    <label for="serial_number" class="modern-label">{{ __('sold-products.serial_number') }}
                            ...
                            <div class="col-md-4">
                                <div class="modern-form-group">
                                    <label for="sale_date" class="modern-label">{{ __('sold-products.sale_date') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="date" class="modern-input @error('sale_date') is-invalid @enderror"
                                        id="sale_date" name="sale_date"
                                        value="{{ old('sale_date', $soldProduct->sale_date ? $soldProduct->sale_date->format('Y-m-d') : '') }}"
                                        required>
                                    @error('sale_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="modern-form-group">
                                    <label for="warranty_start_date"
                                        class="modern-label">{{ __('sold-products.warranty_start') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="date"
                                        class="modern-input @error('warranty_start_date') is-invalid @enderror"
                                        id="warranty_start_date" name="warranty_start_date"
                                        value="{{ old('warranty_start_date', $soldProduct->warranty_start_date ? $soldProduct->warranty_start_date->format('Y-m-d') : '') }}"
                                        required>
                            ...
                            <div class="col-md-4">
                                <div class="modern-form-group">
                                    <label for="warranty_end_date"
                                        class="modern-label">{{ __('sold-products.warranty_end') }} <span
                                            class="text-danger">*</span></label>
                                    <input type="date"
                                        class="modern-input @error('warranty_end_date') is-invalid @enderror"
                                        id="warranty_end_date" name="warranty_end_date"
                                        value="{{ old('warranty_end_date', $soldProduct->warranty_end_date ? $soldProduct->warranty_end_date->format('Y-m-d') : '') }}"
                                        required>
                            ...
                            <div class="col-md-6">
                                <div class="modern-form-group">
                                    <label for="purchase_price"
                                        class="modern-label">{{ __('sold-products.purchase_price') }}</label>
                                    <input type="number" step="0.01" min="0"
                                        class="modern-input @error('purchase_price') is-invalid @enderror"
