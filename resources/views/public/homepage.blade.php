...
@section('description', 'Discover industry-leading drilling equipment and machinery solutions. Quality products for
            ...
            <div class="text-center">
                ...
                <div class="space-x-4">
                    <a href="{{ route('products.index') }}"
                        class="bg-orange-600 hover:bg-orange-700 text-white px-8 py-3 rounded-lg text-lg font-semibold inline-block transition-colors">
                        {{ __('Explore Products') }}
                    </a>
                    <a href="{{ route('serial-lookup.index') }}"
                        class="bg-transparent border-2 border-white hover:bg-white hover:text-blue-900 text-white px-8 py-3 rounded-lg text-lg font-semibold inline-block transition-colors">
                        {{ __('Serial Lookup') }}
                    </a>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">
                        {{ __('All our equipment meets the highest international standards for quality and safety.') }}</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">
                        {{ __('State-of-the-art technology ensuring maximum efficiency and performance.') }}</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @for ($i = 1; $i <= 3; $i++)
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div class="p-6">
                                <h3 class="text-xl font-semibold mb-2">{{ __('Featured Product') }} {{ $i }}
                                </h3>
